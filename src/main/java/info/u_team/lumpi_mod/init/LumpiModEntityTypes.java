...
public class LumpiModEntityTypes {
	...
	public static final RegistryObject<EntityType<LumpiEntity>> LOADED_LUMPI = ENTITY_TYPES.register("loaded_lumpi", () -> EntityType.Builder.create(LumpiEntity::new, EntityClassification.AMBIENT).size(0.6F, 0.85F).trackingRange(64).updateInterval(3).setShouldReceiveVelocityUpdates(true));
	public static final RegistryObject<EntityType<LumpiEntity>> STEEL_LUMPI = ENTITY_TYPES.register("steel_lumpi", () -> EntityType.Builder.create(LumpiEntity::new, EntityClassification.AMBIENT).size(0.6F, 0.85F).trackingRange(64).updateInterval(3).setShouldReceiveVelocityUpdates(true));
