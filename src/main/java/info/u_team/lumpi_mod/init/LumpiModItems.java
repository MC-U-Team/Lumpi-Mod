...
public class LumpiModItems {
	...
	public static final RegistryObject<USpawnEggItem> STEEL_LUMPI_SPAWN_EGG = ITEMS.register("steel_lumpi_spawn_egg", () -> new LumpiSpawnEggItem(LumpiModEntityTypes.STEEL_LUMPI, Rarity.EPIC, 0x292727, 0xd1b4b4));
